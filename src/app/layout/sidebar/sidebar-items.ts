...
export const ROUTES: RouteInfo[] = [
  ...
  {
    path: '/medium/bienes-asegurados/dashboard',
    ...
    submenu: [
      {
        path: '/medium/bienes-asegurados/registro-aseguramiento',
        title: 'Registro de Aseguramiento',
        iconType: '',
        icon: '',
        class: 'ml-menu',
        groupTitle: false,
      ...
      {
        path: '/medium/bienes-asegurados/aeronaves',
        title: 'Aeronaves',
        iconType: '',
        icon: '',
        class: 'ml-menu',
      ...
      {
        path: '/medium/bienes-asegurados/embarcaciones',
        title: 'Embarcaciones',
        iconType: '',
        icon: '',
        class: 'ml-menu',
      ...
      {
        path: '/medium/bienes-asegurados/inmuebles',
        title: 'Inmuebles',
        iconType: '',
        icon: '',
        class: 'ml-menu',
      ...
      {
        path: '/medium/bienes-asegurados/numerarios',
        title: 'Numerarios',
        iconType: '',
        icon: '',
        class: 'ml-menu',
  ...
  },
  {
    ...
    submenu: [
      ...
      {
        path: '/medium/formatos-bienes-asegurados/bienes-a-disposicion',
        title: 'Bienes a Disposición',
        iconType: '',
        icon: '',
        class: 'ml-menu',
        groupTitle: false,
  ...
  },
  {
    ...
    submenu: [
      {
        path: '/medium/estados-juridicos/justiciaNet',
        title: 'Historico Estados Jurídicos',
        iconType: '',
        icon: '',
        class: 'ml-menu',
        groupTitle: false,
